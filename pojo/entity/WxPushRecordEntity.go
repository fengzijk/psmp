...
type WxPushRecordEntity struct {
	...
	Md5Code       string `gorm:"type:varchar(20); NOT NULL ; default:''; uniqueIndex: idx_md5,sort:desc; comment:MD5值唯一"`
	...
	AgentId       int    `gorm:"type:int(3) ; NOT NULL; default :0; comment:应用ID"`
