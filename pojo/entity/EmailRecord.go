...
type EmailRecordEntity struct {
	...
	EmailTo       string `gorm:"type:varchar(64) ; NOT NULL; default :''; uniqueIndex: idx_stp,sort:desc; comment:收件人，多个收件人用英文;分隔"`
	Subject       string `gorm:"type:varchar(200) ; NOT NULL; default :''; comment:标题"`
	Content       string `gorm:"type:varchar(1000) ; NOT NULL; default :''; comment:内容正文 "`
